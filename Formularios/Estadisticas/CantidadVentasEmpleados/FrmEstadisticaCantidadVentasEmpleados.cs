...
{
    public partial class FrmEstadisticaCantidadVentasEmpleados : Form
    {
        ...
        public FrmEstadisticaCantidadVentasEmpleados()
        {
            InitializeComponent();
        }

        private void FrmCantidadVentasEmpleados_Load(object sender, EventArgs e)
        {
            CargarFecha();
        }
        ...
        private void ArmarReporte()
        {
            ...
            if (chkTodos.Checked == true)
                ...
                rpvw.LocalReport.ReportEmbeddedResource = "Practico.Formularios.Estadisticas.CantidadVentasEmpleados.CantidadVentasEmpleados.rdlc";
            else
                rpvw.LocalReport.ReportEmbeddedResource = "Practico.Formularios.Estadisticas.CantidadVentasEmpleados.CantidadVentasEmpleados.rdlc";
            ...
            parametros[1] = new ReportParameter("fecha", "Fecha: "+ DateTime.Now.ToShortDateString());
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            if (chkTodos.Checked)
            {
                tabla = ventas.EstadisticaCantidadVentasEmpleados();
            ...
            else
            {
                ...
                {
                    tabla = ventas.EstadisticaCantidadVentasEmpleadosPeriodo(pckDesde.Value, pckHasta.Value);
