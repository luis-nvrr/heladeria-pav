...
{
    public partial class FrmConsultarTelefonosEmpleados : Form
    {
        ...
        public FrmConsultarTelefonosEmpleados()
        {
            InitializeComponent();
        }

        private void FrmConsultarTelefonosEmpleados_Load(object sender, EventArgs e)
        {
